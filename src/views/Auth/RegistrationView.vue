    ...
    <v-row class="flex-column">
      ...
      <v-col>
        <v-form v-model="form" @submit.prevent="onSubmit">
          ...
          <v-text-field v-model="user.email" :readonly="loading" :rules="[validation.emailValidation]" class="mb-2" clearable
            label="Email"></v-text-field>

          <v-text-field v-model="user.password" :readonly="loading" :rules="[validation.required]" clearable label="Password"
